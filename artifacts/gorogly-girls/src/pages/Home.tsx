...
const i18n = {
  tk: {
    ...
    stats: [
      { icon: '♀', num: '1000+', label: 'Agza Zenan' },
      { icon: '🏢', num: '7', label: 'Şaha Aşgabatda' },
      { icon: '💰', num: '100 M', label: 'Synag Bahasy' },
      { icon: '⭐', num: '5+ ýyl', label: 'Tejribe' },
    ],
    services: {
    ...
    schedule: {
      ...
      spots: '✓ Bar ýer', btn: '→', note: '📍 Pilates sapaklary diňe Diýar TM şahasynda geçirilýär. Tel: +993 12 415311',
    },
    branches: {
    ...
    steps: {
      ...
      steps: [
        { icon: '📞', title: 'Jaň et', desc: 'Ýakyn şahasy saýla we jaň et.' },
        { icon: '💪', title: 'Synaga gel', desc: '100 M synag türgenleşigi et.' },
        { icon: '🌟', title: 'Agza bol!', desc: 'Saňa laýyk paket saýla.' },
      ]
    },
    contact: {
    ...
    footer: {
      ...
      credit: 'Bu saýt 🛠️ Ýeňil Web Agentligi tarapyndan döredildi',
  ...
  ru: {
    ...
    stats: [
      { icon: '♀', num: '1000+', label: 'Участниц' },
      { icon: '🏢', num: '7', label: 'Филиалов в Ашхабаде' },
      { icon: '💰', num: '100 М', label: 'Пробная тренировка' },
      { icon: '⭐', num: '5+ лет', label: 'Опыта' },
    ],
    services: {
      title: 'Наши Услуги',
      label: 'Услуги',
    ...
    schedule: {
      ...
      spots: '✓ Есть места', btn: '→', note: '📍 Занятия Pilates только в филиале Диар ТМ. Тел: +993 12 415311',
    },
    branches: {
    ...
    steps: {
      ...
      steps: [
        { icon: '📞', title: 'Позвоните', desc: 'Выберите ближайший филиал и позвоните.' },
        { icon: '💪', title: 'Приходите', desc: 'Попробуйте пробную за 100 М.' },
        { icon: '🌟', title: 'Станьте членом!', desc: 'Выберите подходящий пакет.' },
      ]
    },
    contact: {
    ...
    footer: {
      ...
      credit: 'Сайт создан 🛠️ агентством Yenil Web',
      credit_link: 'yenil.ru',
    }
  }
} as const;
...
// ===== DATA =====
const branches = [
  { id: 1, name_tk: 'Üniwermag Şahasy', name_ru: 'Филиал Универмаг', area_tk: 'Üniwermag ýakynynda', area_ru: 'Рядом с Универмагом', phone: '+993 12 942771', tel: '+99312942771', services: ['gym'], emoji: '🏢', open: '07:00 – 22:00', highlight: false },
  { id: 2, name_tk: '6-njy Mikroraýon', name_ru: '6-й Микрорайон', area_tk: '6-njy mikroraýon', area_ru: '6 микрорайон', phone: '+993 12 286719', tel: '+99312286719', services: ['gym'], emoji: '🏗️', open: '07:00 – 22:00', highlight: false },
  { id: 3, name_tk: 'Çehow Şahasy', name_ru: 'Филиал Чехова', area_tk: 'Çehow köçesi', area_ru: 'Улица Чехова', phone: '+993 12 414296', tel: '+99312414296', services: ['gym'], emoji: '🌆', open: '07:00 – 22:00', highlight: false },
  { id: 4, name_tk: 'Gülzümin Şahasy', name_ru: 'Филиал Гульземин', area_tk: 'Gülzümin etrap', area_ru: 'Район Гульземин', phone: '+993 12 903706', tel: '+99312903706', services: ['gym'], emoji: '🏘️', open: '07:00 – 22:00', highlight: false },
  { id: 5, name_tk: 'Diýar TM — ZENANLAR', name_ru: 'Диар ТМ — ЖЕНСКИЙ', area_tk: 'Seydi köç. 15 ýol, TM Diýar', area_ru: 'ул. Сейди, 15 этап, ТЦ Диар', phone: '+993 12 415311', tel: '+99312415311', services: ['gym', 'pilates'], emoji: '⭐', open: '08:00 – 21:30', highlight: true, special_tk: '⭐ Pilates Reformer hem bar!', special_ru: '⭐ Здесь есть Pilates Reformer!' },
  { id: 6, name_tk: 'Rysga Bank Şahasy', name_ru: 'Филиал Рысгал Банк', area_tk: 'Rysga bank ýakynynda', area_ru: 'Рядом с Рысгал Банком', phone: '+993 12 964992', tel: '+99312964992', services: ['gym'], emoji: '🏦', open: '07:00 – 22:00', highlight: false },
  { id: 7, name_tk: 'Syýahat Myhmanhanasy', name_ru: 'Гостиница Турист', area_tk: 'Syýahat myhmanhanasy ýakynynda', area_ru: 'Рядом с гостиницей Турист', phone: '+993 12 343668', tel: '+99312343668', services: ['gym'], emoji: '🏨', open: '07:00 – 22:00', highlight: false },
];

const trainers = [
  { name: 'Ýekaterina', title_tk: 'Pilates Reformer Instruktory', title_ru: 'Инструктор Pilates Reformer', badges: ['ПН-СР-ПТ: 10:00–13:00', 'ВТ-ЧТ: 17:30–19:30'], spec_tk: 'Pilates Reformer, Beden Formasy, Oňurga saglygy', spec_ru: 'Pilates Reformer, Формирование тела, Здоровье позвоночника', emoji: '🧘', gradient: 'linear-gradient(145deg, #1a0510, #2d0a1e)' },
  { name: 'Ýana', title_tk: 'Pilates Instruktory', title_ru: 'Инструктор Pilates', badges: ['ПН-СР-ПТ: 17:30–20:30'], spec_tk: 'Agşam sapaklary, Dinamiki Pilates, Güýçlendirme', spec_ru: 'Вечерние занятия, Динамический Pilates, Укрепление', emoji: '💫', gradient: 'linear-gradient(145deg, #140a1a, #200e28)' },
  { name: 'Jahana', title_tk: 'Pilates Instruktory', title_ru: 'Инструктор Pilates', badges: ['ПН-СР-ПТ: 13:15–14:15', 'ВТ-ЧТ-СБ: 20:30–21:30'], spec_tk: 'Günortanky we agşam sapaklary, Ynjalyk', spec_ru: 'Дневные и вечерние занятия, Расслабление', emoji: '🌸', gradient: 'linear-gradient(145deg, #0a1020, #101828)' },
  { name: 'Nadezhda', title_tk: 'Pilates Instruktory', title_ru: 'Инструктор Pilates', badges: ['ВТ-ЧТ-СБ: 12:00–13:00'], spec_tk: 'Günortanky sapaklary, Esasy Pilates', spec_ru: 'Дневные занятия, Базовый Pilates', emoji: '🌿', gradient: 'linear-gradient(145deg, #051510, #0a2018)' },
];
...
const programs = [
  { emoji: '🏋️', name_tk: 'Güýç Türgenleşigi', name_ru: 'Силовые тренировки', desc_tk: 'Häzirki zaman trenažýorlar bilen myşsa gurluşy we güýç gazanmak. Hünärmen instruktor goldawy.', desc_ru: 'Набор мышечной массы и развитие силы на современных тренажёрах. Поддержка профессионального инструктора.', intensity: 5, dur_tk: '45-60 min', dur_ru: '45-60 мин' },
  { emoji: '🏃', name_tk: 'Kardio Bölümi', name_ru: 'Кардио зона', desc_tk: 'Ýürek-damar ulgamyňyzy güýçlendiriň, kaloriýa ýakyn. Беговые дорожки, велотренажёры.', desc_ru: 'Укрепление сердечно-сосудистой системы, сжигание калорий. Беговые дорожки, велотренажёры.', intensity: 3, dur_tk: '30-60 min', dur_ru: '30-60 мин' },
  { emoji: '🧘', name_tk: 'Pilates Reformer', name_ru: 'Pilates Reformer', desc_tk: 'Özboluşly Pilates enjamy bilen beden formasy, ýeňillik we güýç. Diňe Diýar şahasynda.', desc_ru: 'Формирование тела, гибкость и силы с помощью реформера. Только в филиале Диар.', intensity: 2, dur_tk: '50-60 min', dur_ru: '50-60 мин' },
  { emoji: '🔥', name_tk: 'HIIT & Aerobika', name_ru: 'HIIT & Аэробика', desc_tk: 'Ýokary intensiwli interval türgenleşigi. Gysga wagtda maksimal netije.', desc_ru: 'Высокоинтенсивные интервальные тренировки. Максимальный результат за короткое время.', intensity: 5, dur_tk: '30-45 min', dur_ru: '30-45 мин' },
  { emoji: '💆', name_tk: 'Stretching & Ýeňillik', name_ru: 'Растяжка & Гибкость', desc_tk: 'Bedeniňizi ýeňilleşdiriň, myşsalaryňyzy dikeldip beriň. Bogunlara we arka goldaw.', desc_ru: 'Расслабление тела, восстановление мышц. Поддержка суставов и спины.', intensity: 1, dur_tk: '45 min', dur_ru: '45 мин' },
  { emoji: '👩‍🏫', name_tk: 'Şahsy Türgenleşik', name_ru: 'Персональные тренировки', desc_tk: 'Instruktoryň size ýörite düzen programması. Çalt we takyk netije.', desc_ru: 'Программа тренировок, составленная специально для вас. Быстрый и точный результат.', intensity: 4, dur_tk: 'Ylalaşyk', dur_ru: 'По договор.' },
];
...
const testimonials = [
  ...
  { name: 'Maral Orazowa', months: 12, result_tk: 'Pilates bilen täze başladym', result_ru: 'Начала новую жизнь с Pilates', text_tk: 'Pilates Reformer — düşünjesi ýokdy, indi bolsa onsyz ýaşap bilemok. Ýekaterina hanym hünärmen we mährem. Diýar şahasy iň gowy!', text_ru: 'О Pilates Reformer не знала ничего, теперь не могу без него. Екатерина — профессионал и очень добрый человек. Филиал Диар лучший!', branch_tk: 'Diýar TM şahasy', branch_ru: 'Филиал Диар ТМ', rating: 5 },
  { name: 'Gülälek Hojamyradowa', months: 6, result_tk: 'Belim sagaldy', result_ru: 'Спина перестала болеть', text_tk: 'Pilates-e geçenimden bäri belim agyrmasy doly geçdi. Nadezhda hanym hünärmenligine we alada beredişine minnetdar.', text_ru: 'С тех пор как начала Pilates, спина перестала болеть. Благодарна Надежде за профессионализм и заботу.', branch_tk: 'Diýar TM — Pilates', branch_ru: 'Диар ТМ — Pilates', rating: 5 },
  { name: 'Leýla Saparowa', months: 14, result_tk: 'Her gün gelýärin', result_ru: 'Прихожу каждый день', text_tk: 'Toraýn kart alyp gymmat bolar öýdüpdim. Ýyllyk arzanladyş ähli zady çözdi. Indi Rysga bank şahasyna her gün gelýärin.', text_ru: 'Думала сетевая карта будет дорого. Скидка на годовой всё решила. Теперь каждый день хожу в филиал Рысгал.', branch_tk: 'Rysga bank şahasy', branch_ru: 'Филиал Рысгал Банк', rating: 5 },
  { name: 'Ogulnar Durdyýewa', months: 3, result_tk: 'Özüme ynam artdy', result_ru: 'Выросла уверенность в себе', text_tk: 'Görogly Girls diňe zenanlar üçin bolany üçin has rahat duýýaryn. Synag türgenleşigi 100 M bilen başladym, indi çäksiz abonementi bar.', text_ru: 'В Görogly Girls чувствую себя комфортнее, потому что только для женщин. Начала с пробной за 100 М, теперь безлимит.', branch_tk: 'Çehow şahasy', branch_ru: 'Филиал Чехова', rating: 5 },
...
function useCountUp(target: string, start: boolean) {
  ...
  useEffect(() => {
    ...
    const t = setInterval(() => {
      ...
      const display = num >= 100 ? Math.round(current).toLocaleString() : current.toFixed(num < 10 ? 0 : 0);
    ...
    <>
      ...
      <nav className={`nav${scrolled ? ' scrolled' : ''}`}>
        ...
        <ul className="nav-links">
          {[['hero','home'],['services','services'],['schedule','schedule'],['services','prices'],['branches','branches'],['contact','contact']].map(([id, key]) => (
            <li key={key}><a href={`#${id}`} onClick={(e) => { e.preventDefault(); scrollTo(id); }}>{t.nav[key as keyof typeof t.nav]}</a></li>
          ))}
        </ul>
        <div className="nav-right">
          ...
          <a href="#contact" className="nav-cta" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{t.nav.cta}</a>
      ...
      <div className={`mobile-menu${mobileOpen ? ' open' : ''}`}>
        ...
        <div className="mobile-menu-bottom">
          ...
          <a href="tel:+99312415311" className="mobile-phone">📞 +993 12 415311</a>
        </div>
      </div>
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <div className="hero-btns">
              <a href="#contact" className="hero-btn-primary" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{t.hero.btn1}</a>
              <a href="#services" className="hero-btn-secondary" onClick={(e) => { e.preventDefault(); scrollTo('services'); }}>{t.hero.btn2}</a>
            </div>
            <div className="hero-trust">
              {t.hero.trust.map((item, i) => (
                <span key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <span className="hero-trust-item"><span className="trust-dot">✦</span> {item}</span>
                  {i < t.hero.trust.length - 1 && <span className="hero-trust-sep" />}
                </span>
              ))}
            </div>
          </div>
          <div className="hero-right">
            {[{ icon: '💪', stat: '7', label: lang === 'tk' ? 'Şaha Aşgabatda' : 'Филиалов в Ашхабаде' }, { icon: '👩', stat: '1000+', label: lang === 'tk' ? 'Agza Zenan' : 'Участниц' }, { icon: '🏆', stat: '100 M', label: lang === 'tk' ? 'Synag Türg.' : 'Пробная тр.' }].map((card, i) => (
      ...
      <div className="stats-strip">
        <div className="stats-grid">
          {t.stats.map((s, i) => (
            <StatItem key={i} icon={s.icon} num={s.num} label={s.label} />
          ))}
        </div>
      </div>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="services-grid">
              ...
              <div className="service-card reveal">
                ...
                <div className="price-table">
                  ...
                  {t.services.gym.discounts.map((p, i) => (
                    <div className="price-row discount highlight-row" key={i}>
                      <span className="price-row-label">{p.label}</span>
                      <span className="price-row-price font-oswald"><span className="price-old">{p.old}</span>{p.price}</span>
                    </div>
                  ))}
                </div>
                ...
                <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '0.75rem' }}>🔒 {t.services.gym.locker}</p>
                <a href="#contact" className="service-btn" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{t.services.gym.btn}</a>
              </div>
              ...
              <div className="service-card featured reveal">
                ...
                <p className="service-address">{t.services.pilates.address}</p>
                <p className="service-address">📞 {t.services.pilates.phone}</p>
                <a href="#contact" className="service-btn" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{t.services.pilates.btn}</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="schedule-list">
              {scheduleData[scheduleTab].map((row, i) => (
                <div className="schedule-row" key={i}>
                  ...
                  <span className="sched-spots">✓ {lang === 'tk' ? 'Bar ýer' : 'Есть места'}</span>
                  <a href="#contact" className="sched-btn" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{lang === 'tk' ? 'Ýazyl →' : 'Записаться →'}</a>
                </div>
              ))}
            </div>
            <div className="schedule-note">{t.schedule.note}</div>
          </div>
        </div>
      </div>
              ...
              {branches.map((b) => (
                <div key={b.id} className={`branch-card reveal${b.highlight ? ' highlight' : ''}`}>
                  ...
                  <div className="branch-tags">
                    {b.services.includes('gym') && <span className="branch-tag">{t.branches.gym}</span>}
                    {b.services.includes('pilates') && <span className="branch-tag" style={{background:'rgba(233,30,140,0.2)',borderColor:'rgba(233,30,140,0.4)'}}>{t.branches.pilates}</span>}
                  </div>
                  <div className="branch-name">{lang === 'tk' ? b.name_tk : b.name_ru}</div>
                  <div className="branch-area">{lang === 'tk' ? b.area_tk : b.area_ru}</div>
                  {b.highlight && (b as any)[`special_${lang}`] && (
                    <div className="branch-special">{(b as any)[`special_${lang}`]}</div>
                  )}
                  <div className="branch-divider" />
                  <div className="branch-info">
                    <div className="branch-info-row">📞 <strong>{b.phone}</strong></div>
                    <div className="branch-info-row">⏰ <span>{t.branches.open}: {b.open}</span></div>
                  </div>
                  <div className="branch-btns">
                    <a href={`tel:${b.tel}`} className="branch-call">{t.branches.call}</a>
                    <a href="#" className="branch-map" onClick={(e) => e.preventDefault()}>{t.branches.map}</a>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="section">
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="trainers-grid">
              {trainers.map((tr, i) => (
                <div key={i} className="trainer-card reveal" style={{ background: tr.gradient }}>
                  <span className="trainer-emoji">{tr.emoji}</span>
                  ...
                  <div className="trainer-schedule-badges">
                    {tr.badges.map((b, j) => <div key={j} className="trainer-schedule-badge">{b}</div>)}
                  </div>
                  <div className="trainer-spec">{lang === 'tk' ? tr.spec_tk : tr.spec_ru}</div>
                  <a href="#contact" className="trainer-cta" onClick={(e) => { e.preventDefault(); scrollTo('contact'); }}>{t.trainers.btn}</a>
                </div>
              ))}
            </div>
          </div>
              ...
              {programs.map((p, i) => (
                <div key={i} className="program-card reveal">
                  ...
                  <div className="program-meta">
                    <span className="program-duration">⏱ {lang === 'tk' ? p.dur_tk : p.dur_ru}</span>
            ...
            <div className="reveal-left">
              ...
              <div className="app-features">
                {t.app.features.map((f, i) => (
                  <div key={i} className="app-feature"><span className="app-feature-dot">✦</span> {f}</div>
                ))}
              </div>
              ...
              <div className="phone-mockup">
                ...
                <div className="phone-screen">
                  ...
                  <div className="phone-widget">
                    ...
                    <div className="phone-widget-val" style={{fontSize:'0.7rem',color:'var(--text-muted)'}}>3 {lang === 'tk' ? 'türgenleşik' : 'тренировки'} ✓</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="testimonials-grid">
              {testimonials.map((test, i) => (
                <div key={i} className="testimonial-card reveal">
                  <div className="test-stars">{Array.from({length: test.rating}).map((_, j) => <span key={j} className="test-star">★</span>)}</div>
                  ...
                  <div className="test-author">
                    ...
                    <div>
                      ...
                      <div className="test-branch">{lang === 'tk' ? test.branch_tk : test.branch_ru}</div>
                ...
                <div className="quick-contacts">
                  {branches.map((b) => (
                    <a key={b.id} href={`tel:${b.tel}`} className="quick-contact-link">
                      📍 {lang === 'tk' ? b.name_tk : b.name_ru}: {b.phone}
                    </a>
                  ))}
                </div>
              </div>
              <div className="form-card reveal-right">
                ...
                {!formSuccess && (
                  <form onSubmit={handleSubmit}>
                    <div className="form-title">{t.contact.form_title}</div>
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://instagram.com/goroglygitnness" target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Instagram">📷</a>
                <a href="tel:+99312415311" className="footer-social-link" title="Phone">📞</a>
              </div>
            </div>
            <div>
      ...
      {/* Back to Top */}
      <button className={`back-top${backTop ? ' visible' : ''}`} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} aria-label="Back to top">↑</button>
    </>
  );
}
